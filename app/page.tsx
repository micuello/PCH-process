...
export default function ProcessFlow() {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", maxWidth: 920, margin: "0 auto", padding: "0 8px" }}>
      {/* Legend */}
      <div
        style={{
          display: "flex",
                          ...
                          {step.fields.length > 0 && (
                            ...
                            >
                              {step.fields.map((f, i) => (
                                ...
                                >
                                  <span style={{ color: phase.color, fontSize: 8, marginTop: 4 }}>
                                    ●
                                  </span>
                                  {f}
                                </div>
                        ...
                        {splitChildren.map((child) => (
                          <div
                            ...
                            style={{
                              ...
                              background:
                                expandedStep === child.id ? child.actorColor + "0A" : "transparent",
                              transition: "all 0.2s",
                            }}
                          >
                            <div
          ...
          {[
            {
              from: "PCH",
              to: "CSA TH",
              data: "Forecast → origin, dest, containers/period",
              color: "#D85A30",
            },
            {
              from: "CSA TH",
              to: "Cargoo",
              data: "Lane matching, allocation split",
              color: "#534AB7",
            },
            {
              from: "CSA TH",
              to: "Carriers",
              data: "Allocated quantities for space reservation",
              color: "#534AB7",
            },
            {
              from: "PCH",
              to: "CSA TH",
              data: "Booking requests → lane, port, ETD, qty, ctn/booking",
              color: "#D85A30",
            },
            {
              from: "CSA TH",
              to: "Cargoo",
              data: "Individual shipments with booking refs",
              color: "#534AB7",
            },
            {
              from: "Cargoo",
              to: "PCH",
              data: "Container pool with unique references",
              color: "#0F6E56",
            },
            {
              from: "PCH",
              to: "Warehouse",
              data: "SKU assignments + picking instructions",
              color: "#D85A30",
            },
            {
              from: "Warehouse",
              to: "PCH",
              data: "Picking status → complete or partial",
              color: "#888780",
            },
          ].map((flow, i) => (
            <div
